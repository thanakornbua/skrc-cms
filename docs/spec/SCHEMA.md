...
| Category config | `CONFIG#CATEGORY#<cat>` | `PROFILE` | integer `minTimeMs`, `stageMaxTimeMs` and `stageMaxAttempts` maps (`ROUND_1`, `BEST_OF_4`, `BEST_OF_2`, `THE_BEST`), legacy `maxTimeMs` fallback, `updatedAt`, `updatedBy` |
