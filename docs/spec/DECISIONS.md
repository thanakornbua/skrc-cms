...
| D13 | Registration email mode | ✅ DECIDED | **Auto-confirm sign-up** (no verification email at sign-up). Forgot-password reset codes still work (Cognito requires a verified email for those; the pre-sign-up trigger auto-verifies). No SES. |
